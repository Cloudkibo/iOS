...
class GroupChatDetailViewController: UIViewController,SocketClientDelegate,UpdateChatDelegate,UIDocumentPickerDelegate,UIDocumentMenuDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,NSFileManagerDelegate,showUploadProgressDelegate{
  ...
  //  @IBOutlet weak var btn_chatDeleteHistory: UIBarButtonItem!
    ...
    override func viewDidLoad() {
       ...
       /* if(self.messages.count>1)
        ...
        //%%%%%%%%%%%%%%%%%&&&&&&&&&&&&&&&&&&^^^^^^^^^
        //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%FetchChatServer()
        self.NewChatNavigationTitle.title="Test"
       ...
       ///////////// let contactProfileImage = Expression<NSData>("profileimage")
        ...
        print("here is query pic \(tbl_allcontacts[phone]) and \(selectedContact)")
        
        do{
            for picquery in try sqliteDB.db.prepare(queryPic) {
                print("here inside of querypic")
